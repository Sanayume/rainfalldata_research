...
*   **特征集 V6 + Optuna 超参数优化 + 5 折交叉验证 (`xgboost1.py` - 修改版):**
...
*   **特征集 V4 (`turn2.py`, 模型 `xgboost2.py`):**
...
*   **特征集 V1 (`turn5_1.py`, 模型 `xgboost5_1.py`):** (*此版本特征工程转向格点数据，结果代表了不同数据处理方式下的性能*)

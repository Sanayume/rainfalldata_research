...
# 定义需要运行的脚本路径
script_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "high_performance_train.py")
...
try:
    ...
    # 打印结果代码
    print("\n" + "="*40)
    print(f"训练完成，退出代码: {result.returncode}")
    print("="*40)
    
except subprocess.CalledProcessError as e:
    print("\n" + "="*40)
    print(f"训练过程中出现错误，退出代码: {e.returncode}")
    print(f"错误信息: {e}")
    print("="*40)
except Exception as e:
    print("\n" + "="*40)
    print(f"运行训练脚本时出现异常: {type(e).__name__}: {e}")
    print("="*40)

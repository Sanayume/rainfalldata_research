...
print("\n--- Step 5: Concatenating Features & Naming (Yangtze v5) ---")
...
X_flat_filename = os.path.join(OUTPUT_DIR, "X_Yangtsu_flat_features_v5.npy") # Add _v5
Y_flat_filename = os.path.join(OUTPUT_DIR, "Y_Yangtsu_flat_target_v5.npy") # Add _v5
feature_names_filename = os.path.join(OUTPUT_DIR, "feature_names_yangtsu_v5.txt") # Add _v5
...
print("\n--- Step 6: Flattening Data (Yangtze v5) ---")
...
# --- 7. Save Data ---
print("\n--- Step 7: Saving Flattened Data (Yangtze v5) ---")
